  ...
  return (
    ...
    <div id='Skills' className={styles.main}>
               ...
               <div className={styles.tech}>
                   ...
                   <div className={styles.flip}><a href="https://www.typescriptlang.org/" target="_blank" rel="noreferrer"> <img src="https://raw.githubusercontent.com/devicons/devicon/master/icons/typescript/typescript-original.svg" alt="typescript"/> </a></div>
               </div>
